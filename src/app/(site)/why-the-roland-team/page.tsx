...
const reasons = [
  {
    ...
    p: "The Roland Team | LPT Realty is a Top 1% Las Vegas real estate team with 1,000+ homes sold. Experience across every price point and community in the valley, from first homes to guard-gated estates.",
  },
  {
